      ...
      <body>
        ...
        %>
            <tr>
               ...
               <td> <a href="prod_cons.jsp?nome_prod=<%= rs.getString("nome") %> "> <%= rs.getString("nome") %> </a> </td>
               <td><%= rs.getString("valor") %></td>
               <td><%= rs.getString("fabricacao") %></td>
               <td> <a href="prod_del.jsp?id=<%= rs.getString("pk_id") %> "> <span class="material-symbols-outlined">delete</span> </a> </td>
               <td> <a href="prod_alt_edit.jsp?id=<%= rs.getString("pk_id") %> "> <span class="material-symbols-outlined">update</span> </td>
            </tr>
        <%
                }    
        %>
